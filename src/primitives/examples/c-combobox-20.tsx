              ...
              <Fragment>
                {selectedMembers.map((member) => (
                  <ComboboxChip
                    key={member.id}
                    showRemove={true}
                    className="bg-background rounded-4xl inline-flex h-auto items-center gap-1.5 border py-0.5 pl-2 shadow-xs **:data-[slot=combobox-chip-remove]:mr-0.5 **:data-[slot=combobox-chip-remove]:bg-transparent"
                  >
