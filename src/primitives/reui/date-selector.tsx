...
import { Calendar, CalendarDayButton } from "@/primitives/reui/calendar";
import { Input } from "@/primitives/reui/input";
import { ScrollArea } from "@/primitives/reui/scroll-area";
import { Tabs, TabsList, TabsTrigger } from "@/primitives/reui/tabs";
          ...
          <div className="flex items-center">
            {(() => {
              ...
              return (
                ...
                >
                  {isFuture ? (
                    <HugeiconsIcon icon={ArrowMoveUpLeftIcon} strokeWidth={2} />
                  ) : (
                    <HugeiconsIcon
