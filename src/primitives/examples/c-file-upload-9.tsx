...
export function Pattern({
  ...
  const getFileIcon = (file: File | FileMetadata) => {
    ...
    if (type.startsWith("video/"))
      return <HugeiconsIcon icon={Video02Icon} strokeWidth={2} />;
    ...
    if (type.includes("pdf"))
      return (
        <HugeiconsIcon icon={File02Icon} strokeWidth={2} className="size-6" />
      );
    ...
    if (type.includes("zip") || type.includes("rar"))
      return (
        <HugeiconsIcon icon={ArchiveIcon} strokeWidth={2} className="size-6" />
      );
    return <HugeiconsIcon icon={File02Icon} strokeWidth={2} />;
  };
